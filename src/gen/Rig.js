...
export const SKIN_SEGMENTS = [
  ...
  { bone: 'chest',     a: [ 0, 1.150, 0 ],      b: [ 0, 1.318, 0 ],      r: 0.21 },
  { bone: 'neck',      a: [ 0, 1.318, 0 ],      b: [ 0, 1.392, 0 ],      r: 0.075 },
  { bone: 'head',      a: [ 0, 1.392, 0 ],      b: [ 0, 1.560, 0 ],      r: 0.20 },

  { bone: 'shoulderL', a: [ -0.052, 1.268, 0 ], b: [ -0.160, 1.255, 0 ], r: 0.085 },
  { bone: 'upperArmL', a: [ -0.160, 1.255, 0 ], b: [ -0.262, 1.038, 0 ], r: 0.070 },
  { bone: 'lowerArmL', a: [ -0.262, 1.038, 0 ], b: [ -0.352, 0.845, 0 ], r: 0.058 },
  { bone: 'handL',     a: [ -0.352, 0.845, 0 ], b: [ -0.400, 0.755, 0 ], r: 0.055 },

  { bone: 'shoulderR', a: [ 0.052, 1.268, 0 ],  b: [ 0.160, 1.255, 0 ],  r: 0.085 },
  { bone: 'upperArmR', a: [ 0.160, 1.255, 0 ],  b: [ 0.262, 1.038, 0 ],  r: 0.070 },
